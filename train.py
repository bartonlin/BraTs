...
def train(args):
    ...
    for epoch in range(start_epoch, start_epoch+args.epochs):
        ...
        for idx, (inputs, targets, paths) in enumerate(trainloader):
            print(idx, inputs, targets, paths)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--img_root", type=str, default="./train/image_T1",
                        help="The directory containing the training image dataset.")
    parser.add_argument("--label_root", type=str, default="./train/label_T1",
